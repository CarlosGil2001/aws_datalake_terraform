...
def lambda_handler(event, context):
    ...
    try:
        # Verificar si la tabla 'ds_salaries_sl' ya existe
        ...
        # Si la tabla 'ds_salaries_sl' no existe, se crea una nueva basada en la tabla 'bk-silverzone-project1-dev-useast1'
        table_exists = False
        response = glue.get_table(
            DatabaseName=database_name,
            Name=old_table_name
        ...
        # Crear la nueva tabla 'ds_salaries_sl'
        glue.create_table(
            DatabaseName=database_name,
    ...
    # Eliminar la tabla 'bk-silverzone-project1-dev-useast1' si existe
    try:
        glue.delete_table(
            DatabaseName=database_name,
            Name=old_table_name
        )
        print("La tabla 'bk-silverzone-project1-dev-useast1' ha sido eliminada correctamente.")
    except glue.exceptions.EntityNotFoundException:
        print("La tabla 'bk-silverzone-project1-dev-useast1' no existe en el catálogo de Glue.")
